<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="ZW.Admin.CustomController.Header" %>
<header id="header" class="clearfix" data-ma-theme="blue">
    <ul class="h-inner">
        ...
        <li class="hi-logo hidden-xs">
            <a href="/" runat="server" id="logo_text"></a>
        </li>
                        ...
                        <div class="list-group">
                            ...
                            <div class="lg-body">
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="Content/bs3/img/demo/profile-pics/1.jpg" alt="">
                                    </div>
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="Content/bs3/img/demo/profile-pics/2.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="Content/bs3/img/demo/profile-pics/3.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                ...
                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img class="lgi-img" src="Content/bs3/img/demo/profile-pics/4.jpg" alt="">
                                    </div>
                                    <div class="media-body">
